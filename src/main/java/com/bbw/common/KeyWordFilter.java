...
public class KeyWordFilter {
				...
				do {
					...
					if (theWord != null && !"".equals(theWord.trim())) {
						...
						if (sss[0] != null && !sss[0].equals("")) {
							if (firstword_fqc.containsKey(sss[0].toCharArray()[0] + "") && firstword_fqc.get(sss[0].toCharArray()[0] + "") > sss[0].length()) {
								// do nothing
							} else {
								firstword_fqc.put(sss[0].toCharArray()[0] + "", sss[0].length());
							}
				...
				do {
					...
					if (theWord != null && !"".equals(theWord.trim())) {
						...
						if (firstword.containsKey(ss.toCharArray()[0] + "") && firstword.get(ss.toCharArray()[0] + "") > ss.length()) {
							...
							firstword.put(theWord.trim().toLowerCase().toCharArray()[0] + "", ss.length());
						}
	...
	public String filter_in(String content, String sta, String usid) {
		...
		HashMap<String, String> wfc_map = KeyWordFilter.getInstance().getWfcMap();
		HashMap<String, String> fqc_map = KeyWordFilter.getInstance().getFqcMap();
		HashMap<String, Integer> firstword_map = KeyWordFilter.getInstance().getFirstwordMap();
		HashMap<String, Integer> firstword_fqc_map = KeyWordFilter.getInstance().getFirstwordFqcMap();
	...
	public String filter_jk(String content, String sta, String usid, String mgcstyle1, String mgcstyle2, String wfcstyle1, String wfcstyle2) {
		if (content == null || content.length() <= 0) {
			return "";
		}
		if (usid == null) {
