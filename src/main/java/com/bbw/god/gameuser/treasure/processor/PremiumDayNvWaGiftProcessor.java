 ...
 */
@Service
public class PremiumDayNvWaGiftProcessor extends TreasureUseProcessor {
    /** 获得每日女娲礼包的概率 */
    private static final Integer GET_GIFT_PRO = 70;
    ...
    public PremiumDayNvWaGiftProcessor() {
        this.treasureEnum = TreasureEnum.PREMIUM_DAY_NV_WA_GIFT;
    ...
    public void open(long uid, int num, RDCommon rd) {
        List<Award> boxAllGoods = boxService.getBoxAllGoods(uid, TreasureEnum.PREMIUM_DAY_NV_WA_GIFT.getValue());
        ...
        awardService.fetchAward(uid, boxAllGoods, WayEnum.PREMIUM_DAY_NV_WA_GIFT, "", rd);
    }
}
