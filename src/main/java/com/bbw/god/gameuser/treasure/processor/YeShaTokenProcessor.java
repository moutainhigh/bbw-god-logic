 ...
 **/
@Service
public class YeShaTokenProcessor extends TreasureUseProcessor {

    public YeShaTokenProcessor() {
        this.treasureEnum = TreasureEnum.YE_CHA_XIN_WU;
    ...
    public void effect(GameUser gu, CPUseTreasure param, RDUseMapTreasure rd) {
        Long uid = gu.getId();
        CardEventPublisher.pubCardAddEvent(uid, 350, WayEnum.ACTIVITY, "打开夜叉信物", rd);
