 ...
 */
@Service
public class IntermediateDayNvWaGiftProcessor extends TreasureUseProcessor{
    /** 获得每日女娲礼包的概率 */
    private static final Integer GET_GIFT_PRO = 15;
    ...
    public IntermediateDayNvWaGiftProcessor() {
        this.treasureEnum = TreasureEnum.INTERMEDIATE_DAY_NV_WA_GIFT;
    ...
    public void open(long uid, int num, RDCommon rd) {
        List<Award> boxAllGoods = boxService.getBoxAllGoods(uid, TreasureEnum.INTERMEDIATE_DAY_NV_WA_GIFT.getValue());
        ...
        awardService.fetchAward(uid, boxAllGoods, WayEnum.INTERMEDIATE_DAY_NV_WA_GIFT, "", rd);
    }
