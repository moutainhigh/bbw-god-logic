...
/**
 * @author suchaobin
 * @description 至尊秘传宝箱处理器
 * @date 2020/3/10 15:02
 */
@Service
public class ZhiZMZBoxProcessor extends TreasureUseProcessor {
	private final static List<Integer> AWARDS = Arrays.asList(21159, 21160, 21161, 21162, 21163, 21164, 21165, 21166, 21183, 21184, 21185);
	private final static int ABLE_SELECTED = 1;

	public ZhiZMZBoxProcessor() {
		this.treasureEnum = TreasureEnum.IMPERIAL_SECRET_SCROLL_BOX;
	...
	public void effect(GameUser gu, CPUseTreasure param, RDUseMapTreasure rd) {
		...
		TreasureEventPublisher.pubTAddEvent(gu.getId(), treasureList, WayEnum.TREASURE_USE, new RDCommon());
