 ...
 */
@Service
public class AdvancedDayNvWaGiftProcessor extends TreasureUseProcessor{
    /** 获得每日女娲礼包的概率 */
    private static final Integer GET_GIFT_PRO = 30;
    ...
    public AdvancedDayNvWaGiftProcessor() {
        this.treasureEnum = TreasureEnum.ADVANCED_DAY_NV_WA_GIFT;
    ...
    public void open(long uid, int num, RDCommon rd) {
        List<Award> boxAllGoods = boxService.getBoxAllGoods(uid, TreasureEnum.ADVANCED_DAY_NV_WA_GIFT.getValue());
        ...
        awardService.fetchAward(uid, boxAllGoods, WayEnum.ADVANCED_DAY_NV_WA_GIFT, "", rd);
    }
}
