 ...
 */
@Service
public class PrimaryDayNvWaGiftProcessor extends TreasureUseProcessor {
    /** 获得每日女娲礼包的概率 */
    private static final Integer GET_GIFT_PRO = 5;
    ...
    public PrimaryDayNvWaGiftProcessor() {
        this.treasureEnum = TreasureEnum.PRIMARY_DAY_NV_WA_GIFT;
    ...
    public void open(long uid, int num, RDCommon rd) {
        List<Award> boxAllGoods = boxService.getBoxAllGoods(uid, TreasureEnum.PRIMARY_DAY_NV_WA_GIFT.getValue());
        ...
        awardService.fetchAward(uid, boxAllGoods, WayEnum.PRIMARY_DAY_NV_WA_GIFT, "", rd);
    }
}
