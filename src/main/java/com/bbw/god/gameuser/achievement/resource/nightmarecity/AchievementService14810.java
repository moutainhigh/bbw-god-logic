...
/**
 * @author suchaobin
 * @description 成就id=14810的service
 * @date 2020/9/15 10:53
 **/
@Service
public class AchievementService14810 extends ResourceAchievementService {
    @Autowired
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        List<UserNightmareCity> list = userCities.stream().filter(tmp -> {
            ...
            return TypeEnum.Water.getValue() == city.getCountry() && city.getLevel() <= 2;
