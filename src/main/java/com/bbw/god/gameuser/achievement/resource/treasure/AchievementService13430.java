...
///**
// * @author suchaobin
// * @description 成就id=13430的service
// * @date 2020/5/18 10:10
// **/
//@Service
//public class AchievementService13430 extends ResourceAchievementService {
//	/**
//	 * 获取当前资源类型
//	 *
//	 * @return 当前资源类型
...
//		TreasureStatistic statistic = service.fromRedis(uid, StatisticTypeEnum.CONSUME, DateUtil.getTodayInt());
//		Map<String, Map<WayEnum, Integer>> totalMap = statistic.getTotalMap();
//		Map<WayEnum, Integer> wayEnumMap = totalMap.get(TreasureTool.getTreasureById(10050).getName());
//		int sum = 0;
//		if (null != wayEnumMap) {
