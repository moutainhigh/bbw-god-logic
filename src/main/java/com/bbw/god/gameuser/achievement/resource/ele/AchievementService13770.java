...
/**
 * @author suchaobin
 * @description 成就id=13770的service
 * @date 2020/5/25 15:10
 **/
@Service
public class AchievementService13770 extends ResourceAchievementService {
	/**
	 * 获取当前资源类型
	 *
	 * @return 当前资源类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		EleStatistic statistic = service.fromRedis(uid, StatisticTypeEnum.GAIN, DateUtil.getTodayInt());
		Map<WayEnum, Integer> totalMap = statistic.getTotalMap();
		return totalMap.get(WayEnum.CZ) == null ? 0 : totalMap.get(WayEnum.CZ);
	}
}
