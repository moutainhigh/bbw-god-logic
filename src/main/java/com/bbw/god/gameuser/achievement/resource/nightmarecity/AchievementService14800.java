...
/**
 * @author suchaobin
 * @description 成就id=14800的service
 * @date 2020/9/15 10:53
 **/
@Service
public class AchievementService14800 extends ResourceAchievementService {
    @Autowired
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        List<UserNightmareCity> list = userCities.stream().filter(tmp -> {
            ...
            return TypeEnum.Wood.getValue() == city.getCountry() && city.getLevel() <= 2;
