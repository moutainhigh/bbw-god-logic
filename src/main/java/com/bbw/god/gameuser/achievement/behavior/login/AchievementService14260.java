package com.bbw.god.gameuser.achievement.behavior.login;
...
/**
 * @author suchaobin
 * @description 成就id=14260的service
 * @date 2020/5/22 13:54
 **/
@Service
public class AchievementService14260 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		LoginStatistic statistic = service.fromRedis(uid, StatisticTypeEnum.NONE, DateUtil.getTodayInt());
		return statistic.getLoginDays();
	}
}
