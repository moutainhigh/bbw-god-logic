...
/**
 * 卡牌类成就17760service 众醉独醒III
 *
 * @author: huanghb
 * @date: 2022/5/4 16:32
 */
@Service
public class AchievementService17760 extends BaseAchievementService {
	@Autowired
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		return (int) xianJues.stream()
				.filter(tmp -> CfgXianJueTool.getComprehendLimitInfo()
						.equals(tmp.gainCurrenAddition(CardEquipmentAdditionEnum.STRENGTH_RATE.getValue())))
				.count();
	}
}
