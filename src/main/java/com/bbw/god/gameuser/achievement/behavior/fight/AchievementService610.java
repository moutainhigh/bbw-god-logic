...
/**
 * @author suchaobin
 * @description 成就id=610的service
 * @date 2020/5/25 9:14
 **/
@Service
public class AchievementService610 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		return winFightMap.get(FightTypeEnum.YG) == null ? 0 : winFightMap.get(FightTypeEnum.YG);
	}
}
