 ...
 */
@Service
public class AchievementService17150 extends BehaviorAchievementService {
    @Override
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        Integer favorability = statistic.getNpcFavorability().get(BusinessGangNpcEnum.CHEN_JG.getName());
