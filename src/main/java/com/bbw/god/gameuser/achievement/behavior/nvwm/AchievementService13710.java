package com.bbw.god.gameuser.achievement.behavior.nvwm;
...
/**
 * @author suchaobin
 * @description 成就id=13710的service
 * @date 2020/5/25 14:32
 **/
@Service
public class AchievementService13710 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		NvwmStatistic statistic = service.fromRedis(uid, StatisticTypeEnum.NONE, DateUtil.getTodayInt());
		return statistic.getTotalFavorite();
	}
}
