 ...
 */
@Service
public class AchievementService16970 extends BehaviorAchievementService {
    /**
     * 获取当前行为类型
     *
     * @return 当前行为类型
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        return statistic.getDefenseFuTuNums().get(FuTuTypeEnum.DEFENSE_FU_TU.getName() + FuTuEnum.THREE_FU_TU.getName());
    }
}
