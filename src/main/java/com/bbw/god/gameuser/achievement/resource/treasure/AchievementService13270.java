...
/**
 * @author suchaobin
 * @description 成就id=13270的service
 * @date 2020/5/22 10:44
 **/
@Service
public class AchievementService13270 extends ResourceAchievementService {
	private static final List<Integer> attackSymbolList = Arrays.asList(20110, 20120, 20130, 20140, 20150, 20160);
	...
	protected int getProgress(TreasureStatistic statistic) {
		...
		Set<String> keys = attackSymbolList.stream().map(s ->
