...
/**
 * @author suchaobin
 * @description 成就id=14820的service
 * @date 2020/9/15 10:53
 **/
@Service
public class AchievementService14820 extends ResourceAchievementService {
    @Autowired
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        List<UserNightmareCity> list = userCities.stream().filter(tmp -> {
            ...
            return TypeEnum.Fire.getValue() == city.getCountry() && city.getLevel() <= 2;
