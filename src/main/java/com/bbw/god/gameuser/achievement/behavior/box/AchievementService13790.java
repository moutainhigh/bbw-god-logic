...
/**
 * @author suchaobin
 * @description 成就id=13790的service
 * @date 2020/5/25 15:18
 **/
@Service
public class AchievementService13790 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		OpenGuildBoxStatistic statistic = service.fromRedis(uid, StatisticTypeEnum.NONE, DateUtil.getTodayInt());
