...
/**
 * @author suchaobin
 * @description 成就240的service
 * @date 2020/5/14 17:32
 **/
@Service
public class AchievementService240 extends ResourceAchievementService {
	/**
	 * 获取当前资源类型
	 *
	 * @return 当前资源类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		Map<WayEnum, Integer> waterMap = statistic.getWaterMap();
		return waterMap.get(WayEnum.CARD_UPDATE) == null ? 0 : waterMap.get(WayEnum.CARD_UPDATE);
	}
}
