 ...
 */
@Service
public class AchievementService16910 extends BehaviorAchievementService {
    /**
     * 获取当前行为类型
     *
     * @return 当前行为类型
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        return statistic.getAttackFuTuNums().get(FuTuTypeEnum.ATTACK_FU_TU.getName() + FuTuEnum.TWO_FU_TU.getName());
    }
}
