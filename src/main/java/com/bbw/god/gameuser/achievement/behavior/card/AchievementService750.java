...
/**
 * @author suchaobin
 * @description 成就id=730的service
 * @date 2020/5/14 17:42
 **/
@Service
public class AchievementService750 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		HierarchyCardStatistic statistic = service.fromRedis(uid, StatisticTypeEnum.NONE, DateUtil.getTodayInt());
