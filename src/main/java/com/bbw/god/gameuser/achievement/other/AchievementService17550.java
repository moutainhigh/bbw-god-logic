...
/**
 * 卡牌类成就17550service 金之仙诀
 *
 * @author: huanghb
 * @date: 2022/5/4 16:32
 */
@Service
public class AchievementService17550 extends BaseAchievementService {
	@Autowired
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		//对应属性卡牌
		List<UserCard> typeCards = cards.stream().filter(tmp -> TypeEnum.Gold.getValue() == tmp.gainCard().getType()).collect(Collectors.toList());
