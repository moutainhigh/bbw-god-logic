...
/**
 * @author suchaobin
 * @description 成就210的service
 * @date 2020/5/14 17:32
 **/
@Service
public class AchievementService210 extends ResourceAchievementService {
	/**
	 * 获取当前资源类型
	 *
	 * @return 当前资源类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		return totalMap.get(WayEnum.CARD_UPDATE) == null ? 0 : totalMap.get(WayEnum.CARD_UPDATE);
	}
}
