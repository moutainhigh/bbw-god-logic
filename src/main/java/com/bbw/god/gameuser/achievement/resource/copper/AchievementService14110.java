...
/**
 * @author suchaobin
 * @description 成就id=14110的service
 * @date 2020/5/27 8:54
 **/
@Service
public class AchievementService14110 extends ResourceAchievementService {
	/**
	 * 获取当前资源类型
	 *
	 * @return 当前资源类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		CopperStatistic statistic = service.fromRedis(uid, StatisticTypeEnum.CONSUME, DateUtil.getTodayInt());
