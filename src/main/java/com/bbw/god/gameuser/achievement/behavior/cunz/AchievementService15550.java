 ...
 */
@Service
public class AchievementService15550 extends BehaviorAchievementService {
    /**
     * 获取当前成就的类型
     *
     * @return 当前成就的类型
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        if (statistic.getDifficultyAccomplishedNums().get(TaskDifficulty.HIGH_LEVEL.getName()) >= 30) {
            return 1;
        }
        return 0;
    }
