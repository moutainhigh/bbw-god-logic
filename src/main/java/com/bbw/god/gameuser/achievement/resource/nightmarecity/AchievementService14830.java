...
/**
 * @author suchaobin
 * @description 成就id=14830的service
 * @date 2020/9/15 10:53
 **/
@Service
public class AchievementService14830 extends ResourceAchievementService {
    @Autowired
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        List<UserNightmareCity> list = userCities.stream().filter(tmp -> {
            ...
            return TypeEnum.Earth.getValue() == city.getCountry() && city.getLevel() <= 2;
