...
/**
 * @author suchaobin
 * @description 成就id=13690的service
 * @date 2020/5/25 14:20
 **/
@Service
public class AchievementService13690 extends ResourceAchievementService {
	/**
	 * 获取当前资源类型
	 *
	 * @return 当前资源类型
	...
	protected int getProgress(TreasureStatistic statistic) {
		...
		for (String key : keySet) {
			...
			sum += wayMap.get(WayEnum.BBX_PICK) == null ? 0 : wayMap.get(WayEnum.BBX_PICK);
		}
		return sum / 2;
	}
}
