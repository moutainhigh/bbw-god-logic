...
/**
 * @author suchaobin
 * @description 成就id=14330的service
 * @date 2020/5/18 10:10
 **/
@Service
public class AchievementService14330 extends ResourceAchievementService {
	/**
	 * 获取当前资源类型
	 *
	 * @return 当前资源类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		Map<WayEnum, Integer> wayEnumMap = totalMap.get(TreasureTool.getTreasureById(31070).getName());
		int sum = 0;
		if (null != wayEnumMap) {
