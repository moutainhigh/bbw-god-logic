...
/**
 * @author suchaobin
 * @description 成就id=13520的service
 * @date 2020/5/19 14:37
 **/
@Service
public class AchievementService13520 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		return winFightMap.get(FightTypeEnum.FST) == null ? 0 : winFightMap.get(FightTypeEnum.FST);
	}
}
