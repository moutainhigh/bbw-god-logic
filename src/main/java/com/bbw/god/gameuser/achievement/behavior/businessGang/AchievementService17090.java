 ...
 */
@Service
public class AchievementService17090 extends BehaviorAchievementService {
    @Override
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        Integer prestige = statistic.getBusinessGangPrestige().get(BusinessGangEnum.ZHAO_BAO.getName());
        if (prestige == null) {
            return 0;
        }
        int target = 9300;
