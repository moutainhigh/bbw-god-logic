...
/**
 * @author suchaobin
 * @description 成就id=640的service
 * @date 2020/5/25 9:14
 **/
@Service
public class AchievementService640 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		return winFightMap.get(FightTypeEnum.TRAINING) == null ? 0 : winFightMap.get(FightTypeEnum.TRAINING);
	}
}
