 ...
 */
@Service
public class AchievementService16890 extends BehaviorAchievementService {
    /**
     * 获取当前行为类型
     *
     * @return 当前行为类型
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        return statistic.getSkillsFuTuNums().get(FuTuTypeEnum.SKILLS_FU_TU.getName() + FuTuEnum.FIVE_FU_TU.getName());
    }
}
