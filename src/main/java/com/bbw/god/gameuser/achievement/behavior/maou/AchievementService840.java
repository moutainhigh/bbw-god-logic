...
/**
 * @author suchaobin
 * @description 成就id=840的service
 * @date 2020/5/25 9:24
 **/
@Service
public class AchievementService840 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		return (int) Stream.of(gold, wood, water, fire, earth).filter(s -> s >= 10).count();
	}
}
