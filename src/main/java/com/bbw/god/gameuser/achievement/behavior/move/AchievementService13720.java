package com.bbw.god.gameuser.achievement.behavior.move;
...
/**
 * @author suchaobin
 * @description 成就id=13720的service
 * @date 2020/5/25 14:32
 **/
@Service
public class AchievementService13720 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		MoveStatistic statistic = service.fromRedis(uid, StatisticTypeEnum.NONE, DateUtil.getTodayInt());
