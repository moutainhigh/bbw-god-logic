 ...
 **/
@Service
public class AchievementService15060 extends BehaviorAchievementService {
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		HexagramStatistic statistic = service.fromRedis(uid, StatisticTypeEnum.NONE, DateUtil.getTodayInt());
		return statistic.getHexagramDownDownNum();
	}
}
