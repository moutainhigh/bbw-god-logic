 ...
 * 青胜于蓝
 * 成就id=15620的service
 * 完成神神叨叨的老者发布的4个难度村庄任务
 *
 * @author fzj
 * @date 2021/8/12 17:33
 */
@Service
public class AchievementService15620 extends BehaviorAchievementService {
    /**
     * 获取当前成就的类型
     *
     * @return 当前成就的类型
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        return statistic.getNpcAccomplishedNums().get(CunZTaskEnum.CUNZ_LAOZHETASK.getName());
    }
}
