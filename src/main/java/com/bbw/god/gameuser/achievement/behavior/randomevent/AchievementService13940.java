...
/**
 * @author suchaobin
 * @description 成就id=13940的service
 * @date 2020/5/27 8:54
 **/
@Service
public class AchievementService13940 extends BehaviorAchievementService {
	/**
	 * 获取当前行为类型
	 *
	 * @return 当前行为类型
	...
	public int getMyProgress(long uid, UserAchievementInfo info) {
		...
		return todayMap.get(YdEventEnum.XIAN_REN) == null ? 0 : todayMap.get(YdEventEnum.XIAN_REN);
	}
}
