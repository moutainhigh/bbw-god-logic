 ...
 */
@Service
public class AchievementService15670 extends BehaviorAchievementService {
    /**
     * 获取当前成就的类型
     *
     * @return 当前成就的类型
    ...
    public int getMyProgress(long uid, UserAchievementInfo info) {
        ...
        return statistic.getNpcAccomplishedNums().get(CunZTaskEnum.CUNZ_XIAOBATASK.getName());
    }
}
