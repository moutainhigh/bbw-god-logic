...
/**
 * @author suchaobin
 * @description 任务id%1000=210的任务对应的service
 * @date 2020/11/25 15:32
 **/
@Service
public class DailyTaskService210 extends BehaviorDailyTaskService {
    /**
    ...
    public List<Integer> getMyTaskIds() {
        return Arrays.asList(21210, 22210, 23210, 24210, 25210);
    }
