...
/**
 * @author suchaobin
 * @description 任务id%1000=17的任务对应的service
 * @date 2020/11/24 16:20
 **/
@Service
public class DailyTaskService17 extends BehaviorDailyTaskService {
    /**
    ...
    public List<Integer> getMyTaskIds() {
        return Arrays.asList(21017, 22017, 23017, 24017, 25017);
    }
    ...
    public int doGetProgress(long uid, int level, int taskId, UserTaskInfo info) {
        ...
        Integer val = todayFightMap.get(FightTypeEnum.TRAINING);
