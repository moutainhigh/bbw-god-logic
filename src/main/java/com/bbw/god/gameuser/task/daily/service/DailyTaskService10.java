...
/**
 * @author suchaobin
 * @description 任务id%1000=10的任务对应的service
 * @date 2020/11/24 14:29
 **/
@Service
public class DailyTaskService10 extends BehaviorDailyTaskService {
    ...
    public List<Integer> getMyTaskIds() {
        return Arrays.asList(21010, 22010, 23010, 24010, 25010);
    }
    ...
    public int doGetProgress(long uid, int level, int taskId, UserTaskInfo info) {
        LoginStatistic statistic = loginStatisticService.fromRedis(uid, StatisticTypeEnum.NONE, DateUtil.getTodayInt());
