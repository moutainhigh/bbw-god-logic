...
/**
 * @author suchaobin
 * @description 任务id%1000=23的任务对应的service
 * @date 2020/11/25 16:01
 **/
@Service
public class DailyTaskService23 extends BehaviorDailyTaskService {
    /**
    ...
    public List<Integer> getMyTaskIds() {
        return Arrays.asList(22023, 23023, 25023);
    }
    ...
    public int doGetProgress(long uid, int level, int taskId, UserTaskInfo info) {
        ...
        Integer val = todayFightMap.get(FightTypeEnum.ZXZ);
