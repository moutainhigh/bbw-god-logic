...
/**
 * @author suchaobin
 * @description 任务id%1000=112的任务对应的service
 * @date 2020/11/25 09:05
 **/
@Service
public class DailyTaskService112 extends BehaviorDailyTaskService {
    /**
    ...
    public List<Integer> getMyTaskIds() {
        return Arrays.asList(21112, 22112, 23112, 24112, 25112);
    }
    ...
    public int doGetProgress(long uid, int level, int taskId, UserTaskInfo info) {
        ...
        Integer qzToday = statistic.getQzToday();
        return qzToday == null ? 0 : qzToday;
    }
