...
/**
 * @author suchaobin
 * @description 任务id%1000=116的任务对应的service
 * @date 2020/11/25 16:43
 **/
@Service
public class DailyTaskService116 extends BehaviorDailyTaskService {
    /**
    ...
    public List<Integer> getMyTaskIds() {
        return Arrays.asList(22116, 23116);
    }
