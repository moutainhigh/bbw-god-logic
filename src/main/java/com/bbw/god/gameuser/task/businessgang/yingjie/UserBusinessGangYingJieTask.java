 ...
 */
@Data
public class UserBusinessGangYingJieTask implements Serializable {
    ...
    /** 任务类别 */
    private Integer taskType = TaskTypeEnum.BUSINESS_GANG_YINGJIE_TASK.getValue();
    /** 开启天数 */
    ...
    public static UserBusinessGangYingJieTask fromTask(CfgTaskEntity task) {
        UserBusinessGangYingJieTask userBrocadeGiftDailyTask = new UserBusinessGangYingJieTask();
