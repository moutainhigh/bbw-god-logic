...
/**
 * @author suchaobin
 * @description 任务id%1000=111的任务对应的service
 * @date 2020/11/25 08:44
 **/
@Service
public class DailyTaskService111 extends BehaviorDailyTaskService {
    /**
    ...
    public List<Integer> getMyTaskIds() {
        return Arrays.asList(21111, 22111, 23111, 24111, 25111);
    }
    ...
    public int doGetProgress(long uid, int level, int taskId, UserTaskInfo info) {
        ...
        Integer val = todayFightMap.get(FightTypeEnum.YG);
