...
/**
 * @author suchaobin
 * @description 任务id%1000=113的任务对应的service
 * @date 2020/11/25 09:05
 **/
@Service
public class DailyTaskService113 extends BehaviorDailyTaskService {
    /**
    ...
    public List<Integer> getMyTaskIds() {
        return Arrays.asList(21113, 22113, 23113, 24113, 25113);
    }
    ...
    public int doGetProgress(long uid, int level, int taskId, UserTaskInfo info) {
        BuildingAwardStatistic statistic = buildingAwardStatisticService.fromRedis(uid, StatisticTypeEnum.NONE, DateUtil.getTodayInt());
        Integer ldfToday = statistic.getLdfToday();
        return ldfToday == null ? 0 : ldfToday;
    }
