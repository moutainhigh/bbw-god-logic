...
@NoArgsConstructor
public class UserDfdjSeasonTask extends UserTask implements Serializable {

    private static final long serialVersionUID = 1L;
    private Date generateTime;// 任务生成时间yyyyMMddHHmmss

    public static UserDfdjSeasonTask fromTask(long guId, CfgTaskEntity task, Date seasonBeginDate) {
        UserDfdjSeasonTask ut = new UserDfdjSeasonTask();
    ...
    public UserDataType gainResType() {
        return UserDataType.DFDJ_SEASON_TASK;
    }
}
