 ...
 * 山泽损卦
 *
 * 随机传送到土区，且接下来2个回合原地不动
 *
 * @author liuwenbin
 *
 */
@Service
public class Hexagram60Processor extends AbstractHexagram{
    @Override
    ...
    public void effect(long uid, RDHexagram rd) {
        ...
        CfgRoadEntity mainCityRoad = RoadTool.getRandomRoadByProperty(TypeEnum.Earth);
