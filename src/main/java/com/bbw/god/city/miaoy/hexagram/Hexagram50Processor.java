 ...
 */
@Service
public class Hexagram50Processor extends AbstractHexagram{
    @Autowired
    ...
    public void effect(long uid, RDHexagram rd) {
        ...
        ServerGod serverGod = this.godService.getUnrealServerGod(gameUser.getServerId(), GodEnum.QS.getValue());
