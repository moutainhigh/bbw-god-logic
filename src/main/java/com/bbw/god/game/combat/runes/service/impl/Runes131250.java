...
/**
 * 龙息符 131200  己方全体卡牌获得龙息技能。（含云台）
 * @author lwb
 * @date 2020/6/8 10:05
 */
@Service
public class Runes131250 extends AbstractAddSkillRunes {
    @Override
    ...
    public List<CfgCardSkill> getAddSkills() {
        ...
        list.add(CardSkillTool.getCardSkillOpById(CombatSkillEnum.LX.getValue()).get());
        return list;
    }
}
