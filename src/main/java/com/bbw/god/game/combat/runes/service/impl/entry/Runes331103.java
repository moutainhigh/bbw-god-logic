...
/**
 * 入骨词条	每回合开始时，我方召唤师减少[2]%当前血量。
 *
 * @author: suhq
 * @date: 2022/9/22 11:57 上午
 */
@Service
public class Runes331103 implements IRoundStageRunes {
    @Override
    public int getRunesId() {
        return RunesEnum.RU_GU_ENTRY.getRunesId();
    }
    ...
    public Action doRoundRunes(CombatRunesParam param) {
        ...
        double deductHpRate = 0.02 * combatBuff.getLevel();
        int deductHp = (int) (performPlayer.getHp() * deductHpRate);
        //构建效果
