...
/**
 *
 * 悲愤（3150）：每回合将己方坟场中每张卡牌攻防的5%，将加到该卡牌的攻防中。每升一阶提高1%的效果。
 *
 */
@Service
public class BattleSkill3150 extends BattleSkillService {
	private static final int SKILL_ID = 3150;// 技能ID
	@Override
	...
	protected Action attack(PerformSkillParam psp) {
		...
		//每回合将己方坟场中每张卡牌攻防的5%，将加到该卡牌的攻防中。每升一阶提高1%的效果。
