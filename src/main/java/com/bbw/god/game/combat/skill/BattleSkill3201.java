...
/**
 * 3201 回光 自身受到法术攻击，则施法者受到同样效果。
 * 
 * @author lsj@bamboowind.cn
 * @version 1.0.0
 * @date 2019-07-12 05:11
 */
@Service
public class BattleSkill3201 extends BattleSkillService {
	private static final int SKILL_ID = CombatSkillEnum.HG.getValue();// 技能ID
	...
	protected Action attack(PerformSkillParam psp) {
		...
		Integer receiveSkillId = psp.getReceiveEffectSkillId();
		if (receiveSkillId==null){
			return action;
		}
