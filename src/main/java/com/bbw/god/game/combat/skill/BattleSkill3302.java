...
/**
 * 怒意：受到普通攻击或技能效果时，提高星级*120点永久攻击值，每阶增加40%效果。
 ...
 */
@Service
public class BattleSkill3302 extends BattleSkillService {
	private static final int SKILL_ID = CombatSkillEnum.NU_YI.getValue();
	...
	public Action attack(PerformSkillParam psp) {
		...
		Double roundAtk = 120 * psp.getPerformCard().getStars() * (1 + 0.4 * psp.getPerformCard().getHv());
