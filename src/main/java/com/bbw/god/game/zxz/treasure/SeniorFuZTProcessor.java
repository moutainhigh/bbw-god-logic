 ...
 * 高级复阵图
 * @author: hzf
 * @create: 2022-09-23 11:49
 **/
@Service
public class SeniorFuZTProcessor extends TreasureUseProcessor  {

    @Autowired
    private ZxzRefreshService zxzRefreshService;

    public SeniorFuZTProcessor() {
        this.treasureEnum = TreasureEnum.ZXZ_SENIOR_FUZT;
