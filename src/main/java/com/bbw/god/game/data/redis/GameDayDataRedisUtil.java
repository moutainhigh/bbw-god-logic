...
public class GameDayDataRedisUtil {
    ...
    private <T extends GameData> void dbLoadToRedis(Class<T> clazz) {
        ...
        List<InsGameDayDataEntity> entityList = dayDataService.selectByDataType(dataType.getRedisKey());
        List<GameData> dataList = new ArrayList<>();
        for (InsGameDayDataEntity entity : entityList) {
